...
const uint64_t COIN                                          = UINT64_C(190000000000000);
const uint64_t TAIL_EMISSION_REWARD                          = UINT64_C(100000000000000);
...
const uint64_t MINIMUM_FEE_V1                                = UINT64_C(100);
const uint64_t MINIMUM_FEE_V2                                = UINT64_C(1000);
const uint64_t MINIMUM_FEE_V3                                = UINT64_C(10000);
