...
namespace WalletConfig
{
   ...
   const std::string addressPrefix = "S1";

   /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
   const std::string ticker = "S1C";
   ...
   const std::string coinName = "StrattnersOneChain";

   /* Where can your users contact you for support? E.g. discord */
   const std::string contactLink = "https://s1c.strattners.com";
